...
- Test262 status as of 2026-05-03:
  ...
  - `language` is not green yet. The latest full language scan records `6217` failing files: `175` intended-scope and `6042` out-of-scope. Recent focused slices cleared intended failures for logical assignment, compound assignment, control-flow completion / iterator-close roots, function and generator families, supported class name-binding / subclass runtime semantics, array/rest/RegExp realm tails, and supported parse-time early errors; the broad intended early-error bucket remains gone.
