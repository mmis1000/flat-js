...
- Test262 status as of 2026-05-01:
  ...
  - `language` is not green yet. Recent focused slices have cleared intended failures for logical assignment, compound assignment, and `switch`; the focused `for-of` slice is partially reduced (`58` to `34` failing files) and now mostly points at abrupt IteratorClose/completion control flow. Remaining active language work is tracked in `plan/test262-language-fix-tracker.md`.
