{
    ...
    const t =  ["t","a","b","","console","log","location","href","c","l","n","k",3988292384,"s","m","i",-1,"length","charCodeAt"]
    const p = new Int32Array(Uint8Array.from(atob(''), c => c.charCodeAt(0)).buffer)
